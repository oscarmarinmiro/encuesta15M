...
tdviz.viz.circleSplash = function (options)

{
    ...
    self.svg = d3.select(self.parentSelect).append("svg")
     ...
     $('#panel').hover(function(){console.log("in");self.div.style("opacity",1);},function(){console.log("out");self.div.style("opacity",0.0)});


        $('#panel').mouseenter(function(){console.log("in");self.div.style("opacity",1.0);self.animationOn=false;});
        $('#panel').mouseleave(function(){console.log("out");self.div.style("opacity",0.0);self.animationOn=true;});

        $('.leftFrame').mouseenter(function(){console.log("out");self.div.style("opacity",0.0);self.animationOn=true;});
...
//            .style("top", "50px");
        ...
        var nodes = d3.range(50).map(function() { return {radius: Math.random() * 30 + 10}; }),
