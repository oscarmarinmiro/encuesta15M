...
tdviz.controller.chordSimpleWordsDates = function(options)
{
...
//
        self.chordChart = tdviz.viz.chordSimpleDates(
            {
                'idName':"chartContent",
                'idInfo': self.idInfo,
                'width':800,
        ...
        d3.json(self.baseJUrl+self.dataFile, function(chordData)
        {
            if(chordData!=null)
            {
               ...
               function dateCallBack(nowDate)
               {
                   ...
                   self.chordChart.render(self.adjacency[self.nowDate.clone().format("YYYYMMDD")],self.dataLabel);

               }

                self.minDate = moment(self.chordData.minDate, "YYYYMMDD");
                self.maxDate = moment(self.chordData.maxDate, "YYYYMMDD");
                ...
                self.mySlider = tdviz.extras.dateSlider(
                   {
                       ...
                       'playName': 'play-on.gif',
                       'pauseName': 'pause-on.gif',
