...
tdviz.controller.network3DCompanies = function(options)
{
        ...
        var injectString =
            ['<div id="infoDiv"></div>',
                ...
                '<div id="contenedorCI" class="contenedorCI">',
                    ...
                    '<br><select id="dataset"><option value="out3DCompanies.json">c100NovemberEvents.json</option></select><br><br>',
                    ...
                    '</div>',
                        ...
                        '<div class="opcionesHeader">Camera Position</div>',
                            '<div class="opcionesContent">',
                                '<form>',
                                    '<select id="cameraPos">',
                                        '<option value="perspective" selected="selected">Perspective View</option>',
                                        '<option value="side">View from side</option>',
