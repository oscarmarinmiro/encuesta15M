...
tdviz.controller.networkCommunitiesEvents = function(options)
{
...
//                   console.log("Para el nodo "+node+" las fechas son "+minDate+" "+maxDate);
//                   console.log("Sus datos de eventos son: ");
//                   console.log(self.eventsData[node]);

            if(minDate=="20200101")
            {
//                       console.log("Este nodo no tiene info de eventos...");
...
//                       console.log("Y su eventsTL queda asi");
//                       console.log(self.eventsTL[node]);
            }
            else
            {
...
//                           console.log("Se ha extendido la fecha...");
                }
...
//        myHtml+= "<b>CIV_I</b> "+node.civ_i+"<br>";
    ...
    $(document).ready(function()
    {
                ...
                '<div id="contenedorCI" class="contenedorCI">',
                    ...
                    '<div id="zonaInfo" class="zonaInfo">',
                        '<div class="news">',
                            ...
                            '<br><select id="dataset"><option value="c100November_O2.json">c100November_O2.json</option><option value="comm_sample_O2.json">comm_sample_O2.json</option><option value="high_cis_O2.json">high_cis_O2.json</option><option value="high_multipe_cps_O2.json">high_multipe_cps_O2.json</option></select><br><br>',
                        ...
                        '<div class="opcionesContent">',
                            '<form>',
                                ...
                                '</select>',
                                '<br><br><input name="checkStroke" type="checkbox" value="1" class="checkStroke"/>See companies (stroke)',
                            '</form>',
                        '</div>',
        ...
        self.networkChart = tdviz.viz.networkDiagramCommunitiesEvents(
            {
                'idName':"chartContent",
                'idInfo': self.idInfo,
                'width':800,
...
//               console.log("Los eventos desde los datos:");
...
//               console.log(self.eventsTL);
               ...
               function dateCallBack(nowDate)
               {
                   ...
                   self.networkChart.render(self.netData,self.nowDate,self.dataIn,self.eventsTL,self.strokeCheck);
               ...
               $(".checkStroke").click(function(event){
                   if($(this).is(":checked"))
                   {
                       self.strokeCheck = true;
                       self.networkChart.render(self.netData,self.nowDate,self.dataIn,self.eventsTL,self.strokeCheck);
